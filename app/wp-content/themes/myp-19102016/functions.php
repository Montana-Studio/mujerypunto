...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        wp_enqueue_script('shortener', get_template_directory_uri() . '/js/urlshortener.min.js', array(), '20160606', true ); 


        wp_register_script('mypjs', get_template_directory_uri() . '/js/mujerypunto.min.js', array(), '2.7.1', true); // Modernizr
        wp_enqueue_script('mypjs'); // Enqueue it!
...
function html5blank_styles()
{
    ...
    wp_register_style('mypcss', get_template_directory_uri() . '/css/mujerypunto.css', array(), '1.0', 'all');
    wp_enqueue_style('mypcss'); // Enqueue it!
}
...
function custom_gallery( $output, $attr ){
    ...
    foreach ( $attachments as $id => $attachment ) {
        ...
        $output .= "<{$itemtag} class=\"gallery-item swiper-slide\"><div class='item-imagen-post' style='background-image:url(".$image.");'>";
        //$output .= $image;
