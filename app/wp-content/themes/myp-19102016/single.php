										...
										<div class="post-inside">
											...
											<div class="social-share">
												<ul>
													...
													<li>
														<a class="twitter_relacionados_1" data-img="<?php global $post; $thumbID = get_post_thumbnail_id( $post->ID ); if($thumbID){$imgDestacada = wp_get_attachment_url( $thumbID ); echo $imgDestacada; }else{ echo $first_img;}?>'">
															<i class="fa fa-twitter"></i>
														</a>
													</li>
													<li>
														<a class="plus_relacionados_1" data-img="<?php global $post; $thumbID = get_post_thumbnail_id( $post->ID ); if($thumbID){$imgDestacada = wp_get_attachment_url( $thumbID ); echo $imgDestacada; }else{ echo $first_img;}?>'">
